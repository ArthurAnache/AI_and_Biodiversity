...
for col in monthly_cols:
    df[f"{col}_lag1"] = df.groupby(group_keys)[col].shift(1)
...
# DMatrix keeps feature names if DataFrame is passed; set explicitly to be safe
...
# ---------- Feature importances ----------
# importance_type in {"weight","gain","cover","total_gain","total_cover"}
importance_type = "gain"
imp_dict = booster.get_score(importance_type=importance_type)

# Make sure every feature appears (default 0 if unseen)
